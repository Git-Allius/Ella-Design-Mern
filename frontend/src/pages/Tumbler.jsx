      ...
      <div>
       ...
       <div className="small-container">
        <div className="single-product">
          <div className="row">
            <div className="col-2">
              <img src={tumbler} className="singleImage" alt="T-Shirt" />
            ...
            <div className="col-2">
              ...
              <Link to="/tumblercustomization" className="btn">Start Customizing</Link>
              <h3>Product Details <i className="fa fa-indent"></i></h3>
              <br />
              <p style={{ width: '300px' }}>
              Want to have a cool tumbler to bring to school or to work? Just paste in what you want on it and you're ready to go!
              </p>
            </div>
          </div>
        </div>
